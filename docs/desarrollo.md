...
Cada card deberá tener un botón que dispare la acción de guardar una card que queremoshttps://github.com/Roberto-Giler/ctd-esp-fe3-final.git destacar, dentro del localStorage. Deberás utilizar useReducer para manejar esta lógica.
